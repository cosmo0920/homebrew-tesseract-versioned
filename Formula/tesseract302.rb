class Tesseract302 < Formula
  desc "OCR (Optical Character Recognition) engine"
  homepage "https://github.com/tesseract-ocr/"
  url "https://github.com/tesseract-ocr/tesseract/archive/3.02.02.tar.gz"
  sha256 "1566a78f81570e7dc656e881a0fa688fe1c700d4657041807f2160bf67fbb485"

  conflicts_with "tesseract",
                 :because => "Conflicts with tesseract in main repository."
